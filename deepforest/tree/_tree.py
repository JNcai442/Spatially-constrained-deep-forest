# encoding: utf-8
# module deepforest.tree._tree
# from E:\anaconda\lib\site-packages\deepforest\tree\_tree.cp39-win_amd64.pyd
# by generator 1.147
# no doc
...
class TreeBuilder(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002C470DDC120>'
...
class DepthFirstTreeBuilder(TreeBuilder):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002C470DDC180>'
...
class DTYPE(__numpy.unsignedinteger):
    """
...
class Tree(object):
    ...
    internal_capacity = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    internal_node_count = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    leaf_capacity = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    leaf_node_count = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    n_internals = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002C470DDC0C0>'


# variables with complex values

NODE_DTYPE = None # (!) real value is "dtype([('left_child', '<i4'), ('right_child', '<i4'), ('feature', '<i4'), ('threshold', 'u1')])"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C470DD4B80>'

__spec__ = None # (!) real value is "ModuleSpec(name='deepforest.tree._tree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002C470DD4B80>, origin='E:\\\\anaconda\\\\lib\\\\site-packages\\\\deepforest\\\\tree\\\\_tree.cp39-win_amd64.pyd')"
